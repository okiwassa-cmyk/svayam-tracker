...
export async function POST(req: NextRequest) {
  try {
    ...
    const numericFields = ['energy_level', 'agni', 'weight', 'body_fat', 'waist_cm', 'sleep_hours', 'hrv', 'calories', 'morning_clarity', 'tongue_coating', 'morning_hunger', 'dinner_time', 'dinner_amount', 'alcohol', 'sleep_score', 'resting_hr', 'upper_arm_cm', 'hip_cm', 'thigh_cm', 'bust_cm', 'calf_cm', 'menstruation', 'bp_systolic', 'bp_diastolic', 'bp_pulse']
